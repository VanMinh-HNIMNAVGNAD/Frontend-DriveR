    ...
    <AuthBackground>
      ...
      <div className="w-full max-w-sm bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl shadow-black/50 ring-1 ring-white/5 relative z-10">
        ...
        <p className="text-xs text-slate-400 text-center mt-1 mb-6">
          Truy cập toàn bộ hệ sinh thái lưu trữ đám mây
        </p>

        {/* Social login — ban đầu đen trắng, hover hiện màu chuẩn */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-11 mt-6 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium transition flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg shadow-blue-600/20"
          >
