...
import { HardDrive, Lock, Mail, User, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 border border-white/10 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl space-y-6 relative z-10">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-white">Đăng ký driveR</h2>
          <p className="text-xs text-slate-400">Tạo tài khoản lưu trữ đám mây Multi-Cloud của bạn</p>
        </div>

        {isSuccess && (
          <div className="p-3 bg-emerald-500/20 border border-emerald-500/30 rounded-xl text-xs text-emerald-300 text-center font-medium">
